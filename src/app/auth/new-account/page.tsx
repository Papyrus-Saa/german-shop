...
export default function () {
  return (
    <div className="flex flex-col px-2 min-h-screen pt-32 sm:pt-52 text-center bg-white dark:bg-black">
      <h1 className={`${titleFont.className} text-4xl mb-5`}>Create New Account</h1>
      ...
      <div className="flex flex-col w-full mx-auto sm:w-[400px] p-2">
        ...
        <button className="relative bg-green-600 text-black dark:hover:text-white hover:bg-transparent duration-500 group px-6">
          Create Account
        ...
        <Link
          href="/auth/login"
          className="relative bg-green-600 text-black dark:hover:text-white hover:bg-transparent duration-500 group px-6 text-center "
        >
          Log In
          <span className="absolute bottom-0 left-1/2 w-0 h-[2px] bg-orange-600 transition-all duration-500 group-hover:w-full group-hover:left-0"></span>
        </Link>
